...
```bash
git clone https://github.com/ckgerteis/openalex-mcp
cd openalex-mcp
python -m venv .venv
...
`python mcpb/build.py` writes `dist/openalex-mcp-<version>.mcpb`. The bundle vendors nothing: its manifest
