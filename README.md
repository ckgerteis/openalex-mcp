...
```bash
pip install "git+https://github.com/ckgerteis/openalex-mcp@v2.1.0"
# or, without an environment of your own:
uvx --from "git+https://github.com/ckgerteis/openalex-mcp@v2.1.0" openalex-mcp
```
