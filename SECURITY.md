...
The latest release on the [releases page](https://github.com/ckgerteis/openalex-mcp/releases) is
...
or email christopher.gerteis@gmail.com with "openalex-mcp security" in the subject. Say which version, how to reproduce, and
